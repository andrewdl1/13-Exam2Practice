...
def run_test_practice_problem2a():
    ...
    expected = [22, 30, 25, 0, 28]
    actual = practice_problem2a([12, 20, 15, -10, 18], 10)
    print('test 2')
    print('ecpected', expected)
    print('actual  ', actual)

    expected = [10, 22, 333, 1000, 49, 0, 1]
    actual = practice_problem2a([10, 22, 333, 1000, 49, 0, 1], 0)
    print('test 3')
    print('ecpected', expected)
    print('actual  ', actual)

    expected = [15, 27, 338, 1005, 54, 5, 6]
    actual = practice_problem2a([10, 22, 333, 1000, 49, 0, 1], 5)
    print('test 4')
    print('ecpected', expected)
    print('actual  ', actual)
